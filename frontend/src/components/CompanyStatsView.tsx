...
export const CompanyStatsView: React.FC<CompanyStatsViewProps> = ({
  ...
  return (
    <div className="space-y-5">
      {/* Top Banner & Fast Add */}
      <div className="p-5 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800/90 shadow-sm dark:shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      {filteredStats.length === 0 ? (
        <div className="p-8 text-center rounded-3xl bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 text-xs font-medium shadow-sm">
          {t('no_companies')}
        </div>
      ) : (
