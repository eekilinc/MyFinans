...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-slate-900/80 dark:bg-slate-950/80 border-b border-slate-800/80 shadow-sm transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-cyan-500 flex items-center justify-center shadow-lg shadow-purple-500/20 text-white font-extrabold text-xl tracking-tight">
                M
              </div>
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  ...
                  <span className="text-[10px] font-semibold text-purple-400/90">v12.0</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center bg-slate-800/70 dark:bg-slate-900/80 border border-slate-700/60 rounded-2xl p-1 shadow-inner">
            <button
              onClick={onPrevMonth}
            ...
            <button
              ...
              className="px-3 py-1 text-xs sm:text-sm font-bold text-slate-100 hover:text-purple-400 transition-colors whitespace-nowrap"
              title="Bugüne Dön"
            >
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              onClick={onExportCSV}
              className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-800/60 hover:bg-emerald-950/40 border border-slate-700/50 hover:border-emerald-700/50 text-xs font-semibold text-slate-300 hover:text-emerald-400 transition-all shadow-sm active:scale-95"
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-800/60 hover:bg-purple-950/40 border border-slate-700/50 hover:border-purple-700/50 text-xs font-semibold text-slate-300 hover:text-purple-400 transition-all shadow-sm active:scale-95"
            ...
            <button
              onClick={onOpenAbout}
              className="hidden sm:block p-2.5 rounded-xl bg-slate-800/60 hover:bg-slate-700/70 border border-slate-700/50 text-slate-300 hover:text-white transition-all shadow-sm active:scale-95"
              title={t('app_about')}
            >
        ...
        <div className="flex items-center justify-between pb-3 pt-1 gap-2 overflow-x-auto">
          {/* Tabs */}
