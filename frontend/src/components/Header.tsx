        ...
        <div className="sm:hidden py-2 space-y-2">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            >
              ...
              <span>{t('add_group') ? (t('add_group').split(' ')[0] || 'Grup') : 'Grup'}</span>
            </button>
          </div>
        </div>
